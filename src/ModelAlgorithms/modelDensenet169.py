...
def PlotAccuracy(history):
    ...
    plt.savefig('./Results_Densenet169/plots/accuracy169.png')
...
def PlotLoss(history):
    ...
    plt.ylabel('Loss')
    plt.legend(loc='lower right')
    plt.savefig('./Results_Densenet169/plots/loss169.png')
...
if __name__ == '__main__':
    ...
    model = tf.keras.applications.DenseNet169(weights=None, include_top=False,
