...
def PlotAccuracy(history):
    ...
    plt.savefig('./Results_Densenet201/plots/accuracy201.png')
...
def PlotLoss(history):
    ...
    plt.ylabel('Loss')
    plt.legend(loc='lower right')
    plt.savefig('./Results_Densenet201/plots/loss201.png')
...
if __name__ == '__main__':
    ...
    model = tf.keras.applications.DenseNet201(weights=None, include_top=False,
